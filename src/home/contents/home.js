...
export const Home = () => {
    ...
    const remoteInfos = [
        {title: 'Hire', subTitle: 'employees', des: 'Join the fleet of companies that are benefiting from remote work arrangements by allowing their employees to work from home while saving a lot of cash.', icons: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" className='fa'>
        ...
        {title: 'Explore', subTitle: 'job offers', des: 'Find remote jobs and work from anywhere you wish.', icons: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 42" className='fa'>
        ...
        {title: 'Outsource', subTitle: 'software development', des: 'When you outsource your software project to our in-house engineers and product Managers, we take care of the development processes while you focus on other things that matter and never have to worry about the technical aspect of your business.', icons: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" className='fa'>
