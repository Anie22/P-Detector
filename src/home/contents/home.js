...
export const Home = () => {
    ...
    const remoteInfos = [
        {title: 'Hire', subTitle: 'employees', des: 'Join the fleet of companies that are benefiting from remote work arrangements by allowing their employees to work from home while saving a lot of cash.', link: '/hire', icons: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" className='fa'>
        ...
        {title: 'Explore', subTitle: 'job offers', des: 'Find remote jobs and work from anywhere you wish.', link: '/jobs', icons: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 42" className='fa'>
    ...
    const services = [    
        {title: <h4>“All your <span>technical needs covered </span> under a single monthly subscription.”</h4>, buttonText: "Let's Build", buttonFunction: '/book-demo'},
